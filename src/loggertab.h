    ...
    private:
      ...
      class MsgColumns : public Gtk::TreeModel::ColumnRecord {
          public:
              ...
              /** Gtk::TreeModelColumn that holds the direction of the message */
              Gtk::TreeModelColumn<Glib::ustring> dir;
              /** Gtk::TreeModelColumn that holds the time of the message */
              Gtk::TreeModelColumn<Glib::ustring> time;
              /** Gtk::TreeModelColumn that holds the type of the message */
              Gtk::TreeModelColumn<Glib::ustring> type;
              /** Gtk::TreeModelColumn that holds some data of the message */
              Gtk::TreeModelColumn<Glib::ustring> msg;
          };

      Gtk::ScrolledWindow           scw_msgs;
